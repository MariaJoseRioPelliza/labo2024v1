...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0001_canritos0.8_1", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0001_canritos0.8_1", "DT0001_canritos0.8_1" )

  DR_drifting_guantesblancos( "DR0001_canritos0.8_1", "CA0001_canritos0.8_1" )
  FE_historia_guantesblancos( "FE0001_canritos0.8_1", "DR0001_canritos0.8_1" )

  TS_strategy_guantesblancos_202109( "TS0001_canritos0.8_1", "FE0001_canritos0.8_1" )

  HT_tuning_guantesblancos( "HT0001_canritos0.8_1", "TS0001_canritos0.8_1" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0001_canritos0.8_1", c("HT0001_canritos0.8_1","TS0001_canritos0.8_1") )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS0002_canritos0.8_1", "FE0001_canritos0.8_1" )

  HT_tuning_guantesblancos( "HT0002_canritos0.8_1", "TS0002_canritos0.8_1" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0002_canritos0.8_1", c("HT0002_canritos0.8_1", "TS0002_canritos0.8_1") )
...
corrida_guantesblancos_202109( "gb01_canritos0.8_1" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

corrida_guantesblancos_202107( "gb02_canritos0.8_1" )