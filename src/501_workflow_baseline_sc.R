...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT001_baseline_sc", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA001_baseline_sc", "DT001_baseline_sc" )
  
  DR_drifting_guantesblancos( "DR001_baseline_sc", "CA001_baseline_sc" )
  FE_historia_guantesblancos( "FE001_baseline_sc", "DR001_baseline_sc" )
  
  TS_strategy_guantesblancos_202109( "TS001_baseline_sc", "FE001_baseline_sc" )
  
  HT_tuning_guantesblancos( "HT001_baseline_sc", "TS001_baseline_sc" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ001_baseline_sc", c("HT001_baseline_sc","TS001_baseline_sc") )
...
corrida_guantesblancos_202109( "baseline_sc" )
