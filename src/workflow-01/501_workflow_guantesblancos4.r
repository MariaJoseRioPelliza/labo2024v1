...
FE_historia_guantesblancos <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$CanaritosAsesinos$desvios <- 3.5
...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  ZZ_final_guantesblancos( "ZZ0001", c("HT00013","TS00013") )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS00023", "FE00013" )

  HT_tuning_guantesblancos( "HT00023", "TS00023" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0002", c("HT00023", "TS00023") )
