...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT001_canaritos_15_1", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA001_canaritos_15_1", "DT001_canaritos_15_1" )
  
  DR_drifting_guantesblancos( "DR001_canaritos_15_1", "CA001_canaritos_15_1" )
  FE_historia_guantesblancos( "FE001_canaritos_15_1", "DR001_canaritos_15_1" )
  
  TS_strategy_guantesblancos_202109( "TS001_canaritos_15_1", "FE001_canaritos_15_1" )
  
  HT_tuning_guantesblancos( "HT001_canaritos_15_1", "TS001_canaritos_15_1" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ001_canaritos_15_1", c("HT001_canaritos_15_1","TS001_canaritos_15_1") )
...
corrida_guantesblancos_202109( "canaritos_15_1" )
