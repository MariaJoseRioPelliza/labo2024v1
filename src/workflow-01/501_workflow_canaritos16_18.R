...
FE_historia_guantesblancos <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$CanaritosAsesinos$ratio <- 1.6
  # desvios estandar de la media, para el cutoff
  param_local$CanaritosAsesinos$desvios <- 1.8
...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT001_canaritos16_18", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA001_canaritos16_18", "DT001_canaritos16_18" )
  
  DR_drifting_guantesblancos( "DR001_canaritos16_18", "CA001_canaritos16_18" )
  FE_historia_guantesblancos( "FE001_canaritos16_18", "DR001_canaritos16_18" )
  
  TS_strategy_guantesblancos_202109( "TS001_canaritos16_18", "FE001_canaritos16_18" )
  
  HT_tuning_guantesblancos( "HT001_canaritos16_18", "TS001_canaritos16_18" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ001_canaritos16_18", c("HT001_canaritos16_18","TS001_canaritos16_18") )
...
corrida_guantesblancos_202109( "canaritos16_18" )
