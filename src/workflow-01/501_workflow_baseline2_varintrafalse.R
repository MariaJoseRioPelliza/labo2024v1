...
FE_historia_guantesblancos <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$Boruta$max_runs <- 70
...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT00_BaseLine2", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA00_BaseLine2", "DT00_BaseLine2" )
  
  DR_drifting_guantesblancos( "DR00_BaseLine2", "CA00_BaseLine2" )
  FE_historia_guantesblancos( "FE00_BaseLine2", "DR00_BaseLine2" )
  
  TS_strategy_guantesblancos_202109( "TS00_BaseLine2", "FE00_BaseLine2" )
  
  HT_tuning_guantesblancos( "HT00_BaseLine2", "TS00_BaseLine2" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ001_BaseLine2", c("HT00_BaseLine2","TS00_BaseLine2") )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS00_BaseLine2", "FE00_BaseLine2" )
  
  HT_tuning_guantesblancos( "HT00_BaseLine2", "TS00_BaseLine2" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ002_BaseLine2", c("HT00_BaseLine2", "TS00_BaseLine2") )
...
corrida_guantesblancos_202109( "gb1_BaseLine2" )


# Luego partiendo de  FE0035
# genero TS0036, HT0036 y ZZ0036

corrida_guantesblancos_202107( "gb_BaseLine2" )