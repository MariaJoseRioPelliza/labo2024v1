...
FE_historia_guantesblancos <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$CanaritosAsesinos$desvios <- 0.0
...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT001_undersampling_05", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA001_undersampling_0", "DT001_undersampling_00" )
  
  DR_drifting_guantesblancos( "DR001_undersampling_0", "CA001_undersampling_0" )
  FE_historia_guantesblancos( "FE001_undersampling_0", "DR001_undersampling_0" )
  
  TS_strategy_guantesblancos_202109( "TS001_undersampling_0", "FE001_undersampling_0" )
  
  HT_tuning_guantesblancos( "HT001_undersampling_0", "TS001_undersampling_0" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ001_undersampling_0", c("HT001_undersampling_0","TS001_undersampling_0") )
...
corrida_guantesblancos_202109( "undersampling_0" )
