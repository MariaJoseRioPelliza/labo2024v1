...
TS_strategy_baseline_202109 <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$final_train <- c(202107, 202106, 202105, 202104, 202103, 202102, 202101, 202012, 202011, 202010, 202009, 202008, 202002)
  
  
  param_local$train$training <- c(202105, 202104, 202103,202102, 202101, 202012, 202011, 202010, 202009, 202008, 202002)
...
corrida_baseline_semillerio_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_baseline( "DT0001-sem-1", "competencia_2024.csv.gz")
  CA_catastrophe_baseline( "CA0001-sem-1", "DT0001-sem-1" )
  
  DR_drifting_baseline( "DR0001-sem-1", "CA0001-sem-1" )
  FE_historia_baseline( "FE0001-sem-1", "DR0001-sem-1" )
  
  TS_strategy_baseline_202109( "TS0001-sem-1", "FE0001-sem-1" )
  
  HT_tuning_baseline( "HT0001-sem-1", "TS0001-sem-1" )
  
  # El ZZ depente de HT y TS
  ZZ_final_semillerio_baseline( "ZZ0001-sem-1", c("HT0001-sem-1","TS0001-sem-1") )
...
corrida_baseline_semillerio_202109( "semillero-1" )
