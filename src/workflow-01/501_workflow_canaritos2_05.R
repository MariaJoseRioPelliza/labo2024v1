...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT001_canaritos2_05", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA001_canaritos2_05", "DT001_canaritos2_05" )
  
  DR_drifting_guantesblancos( "DR001_canaritos2_05", "CA001_canaritos2_05" )
  FE_historia_guantesblancos( "FE001_canaritos2_05", "DR001_canaritos2_05" )
  
  TS_strategy_guantesblancos_202109( "TS001_canaritos2_05", "FE001_canaritos2_05" )
  
  HT_tuning_guantesblancos( "HT001_canaritos2_05", "TS001_canaritos2_05" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ001_canaritos2_05", c("HT001_canaritos2_05","TS001_canaritos2_05") )
...
corrida_guantesblancos_202109( "canaritos2_05" )
