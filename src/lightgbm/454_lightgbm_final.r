...
PARAM$finalmodel$num_iterations <- 156
PARAM$finalmodel$learning_rate <- 0.0293036162826231
PARAM$finalmodel$feature_fraction <- 0.881379313431041
PARAM$finalmodel$min_data_in_leaf <- 139
PARAM$finalmodel$num_leaves <- 531
